        ...
        <main className="flex-1 ml-64 p-8 bg-gray-100 min-h-screen">
          ...
          <div className="bg-white rounded-xl p-6 flex flex-col items-center max-w-2xl mx-auto my-auto min-h-[400px]">
            ...
            <form
              ...
              className="w-full space-y-6 flex flex-col items-center mt-6"
            >
              ...
              <div className="relative w-40 h-40 rounded-full mb-4">
                ...
                <label
                  ...
                  className="absolute bottom-1 right-1 p-2 bg-white rounded-full border border-gray-300 shadow-md cursor-pointer"
                >
              ...
              <div className="w-[80%] relative">
                <input
                  ...
                  className="w-full p-4 pl-6 pr-12 border border-gray-300 rounded-3xl outline-none bg-gray-100 text-black font-semibold"
                />

            ...
            <div className="w-full flex flex-col items-center mb-8">
              <div className="relative w-full">
                <input
                  ...
                  readOnly
                  value={forumLink}
                  className={`w-full h-[60px] bg-[#D4D4D4] border border-[#D4D4D4] rounded-2xl pl-6 pr-14 text-gray-700 text-xl font-medium transition-all ${
                    isInputFocused ? 'ring-4 ring-[#b8a1ff]' : ''
                  }`}
